...
function LoginForm({ history, setLoading }) {
  ...
  return (
    <div className="LoginContainer">
      ...
      >
        <img
          src={require("./../../../assets/images/favico.png")}
          alt="Logo"
          className="logoLogin"
        />
        <img
      ...
      <div className="aviso">
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://adgrouptraining.com.br/termos.pdf">
          Termos de Serviço
        </a>{" "}
        e{" "}
        <a target="_blank" rel="noopener noreferrer" href="https://adgrouptraining.com.br/pp.pdf">
